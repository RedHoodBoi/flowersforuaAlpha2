...
import MockShareDialog from "../MockComponentst/MockShareDialog.component";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="w-[720px] h-[480px] flex items-center justify-center  flex-col gap-4 overflow-hidden    "
      >
